...
function Index() {
  ...
  const toUsers = () => history.push('/login');
  const toMessage = () => history.push('./messages')
    return (
        <div>
        ...
        <div className="row">
            <div className='col s12 flex'>
              <div className="col s2">
                <button id='zero' className="btn-floating btn-large white left" onClick={toMessage}><i className="material-icons purple-text text-darken-4">message</i></button>
              </div>
              ...
              <div className="col offset-s3 s2">
                <button className="btn-floating btn-large white right" onClick={toUsers}><i className="material-icons purple-text text-darken-4">account_circle</i>
                </button>
              </div>
            </div>
        </div>
